Enact.react_class.Fields.Tweet = React.createClass({displayName: "Tweet",
    ...
    render: function(){
        ...
        if(tweet){
            tweet = React.createElement("div", {dangerouslySetInnerHTML: { __html : tweet}});
        }//if

        return (
                React.createElement("div", null, 
                    React.createElement("input", {type: "text", defaultValue: this.state.field.value, onChange: this.onChange, placeholder: "Paste Twitter URL..."}), 
                    React.createElement("div", {className: this.getErrorClass()}, this.state.error), 
                    tweet
                )
            );
